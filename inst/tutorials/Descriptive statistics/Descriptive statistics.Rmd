---
title: "Exploratory Analysis 2: Descriptive statistics"
output: 
  learnr::tutorial:
    progressive: true
    theme: cerulean
...
```{r fig.cap = "**Figure 1** Frequency histogram of lysozyme activity for 194 people", fig.height = 5, fig.width = 4}
...
```{r mean4, exercise = TRUE, fig.height = 5, fig.width =4}
