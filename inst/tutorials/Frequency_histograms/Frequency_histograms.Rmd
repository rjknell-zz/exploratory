---
title: "Exploratory Analysis 1: Frequency Histograms"
output: 
  learnr::tutorial:
    progressive: true
    theme: cerulean
...
```{r histogram1, exercise = TRUE, fig.height = 4, fig.width = 5}
...
```{r histogram2, exercise = TRUE, fig.height = 4, fig.width = 5}
